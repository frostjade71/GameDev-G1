        ...
        <div class="teacher-container">
            <div class="vocabulary-section">
                <div class="section-header">
                    <h3 style="transform: translateY(-3px);"><i class="fas fa-list"></i> All Vocabulary Questions (<?= $total_vocab ?>)</h3>
                ...
                <div class="table-responsive">
                    <table class="vocab-table">
                        <thead>
                            <tr>
                                <th class="sortable" data-sort="word" data-order="asc">Word</th>
                                <th class="sortable" data-sort="definition" data-order="asc">Definition</th>
                            ...
                            <?php else: ?>
                                <?php foreach ($vocabulary_questions as $question): ?>
                                    <tr data-word="<?= strtolower(htmlspecialchars($question['word'])) ?>" 
                                        ...
                                        <td data-label="Definition" class="definition-cell">
