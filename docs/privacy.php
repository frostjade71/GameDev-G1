...
<body>
    ...
    <main class="page-content">
        ...
        <section class="glass-panel">
            ...
            <p>
                Word Weavers is a thesis project developed by Group 3 Computer Science Seniors at Holy Cross College of Carigara Inc. (HCCCI). This Privacy Policy explains how we collect, use, and protect your information when you use our platform.
            </p>
        </section>
        ...
        <section class="glass-panel">
            ...
            <ul>
                ...
                <li>To display leaderboard rankings and GWA calculations</li>
                <li>To enable social features such as friends and profile views</li>
                <li>To allow teachers to monitor student progress</li>
            </ul>
        </section>
