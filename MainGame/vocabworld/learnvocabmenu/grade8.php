...
<head>
    ...
    <title>Grade 8 - Afro-Asian Literature - VocabWorld</title>
        ...
        <div id="main-menu" class="screen active">
            <div class="menu-container">
                ...
                <div class="page-header">
                    <h1 class="page-title">Grade 8 - Afro-Asian Literature</h1>
                ...
                <div class="coming-soon-content">
                    <div class="coming-soon-card">
                        ...
                        <p>We're working hard to bring you comprehensive lessons for Grade 8 Afro-Asian Literature.</p>
                        <p>This section will include:</p>
                        <ul>
                            <li>African Literature and Traditions</li>
                            <li>Asian Literary Works</li>
                            <li>Cultural Perspectives and Themes</li>
