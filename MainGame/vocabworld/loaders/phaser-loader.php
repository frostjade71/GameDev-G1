<?php
/**
 * Vocabworld Phaser Loader Component
 */

$phaserLoaderPath = "";
if (file_exists("loaders/phaser-loader.css")) {
    $phaserLoaderPath = "loaders/";
} elseif (file_exists("../loaders/phaser-loader.css")) {
    $phaserLoaderPath = "../loaders/";
} elseif (file_exists("../../loaders/phaser-loader.css")) {
    $phaserLoaderPath = "../../loaders/";
}
...
<link rel="stylesheet" href="<?php echo $phaserLoaderPath; ?>phaser-loader.css?v=<?php echo time(); ?>">

<div class="phaser-loader-overlay" id="phaserLoader">
    <div class="scene">
        <div class="forest">
    ...
    <div class="loading-text">Entering Elmvale</div>
</div>

<script>
    function hidePhaserLoader() {
        const loader = document.getElementById('phaserLoader');
        if (loader) {
            ...
            setTimeout(() => {
                ...
                }, 600); // Wait for CSS transition (0.5s)
            }, 2000);
        }
    }
</script>
