...
<head>
    ...
    <title>Student Guide — Word Weavers</title>
...
<body>
    ...
    <main class="page-content">
        ...
        <section class="glass-panel">
            ...
            <p>Check the leaderboards to see how you rank against other students. Your scores and GWA are tracked automatically as you play and complete lessons.</p>

            <h3><span class="step-number">5</span> Explore the Platform (Word Weavers)</h3>
            <p>Discover all the features Word Weavers has to offer — from VocabWorld's immersive RPG experience to teacher-assigned lessons, favorites, and more.</p>
        </section>
        ...
        <section class="glass-panel">
            ...
            <p>Your teacher may assign vocabulary lessons for you to study. Here's how to use them:</p>
            <ol>
                ...
                <li>Your performance will be reflected in your GWA (General Weighted Average)</li>
            </ol>
        </section>
