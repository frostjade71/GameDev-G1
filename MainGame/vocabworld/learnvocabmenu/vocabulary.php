...
<head>
    ...
    <title>Learn Vocabulary - Grade <?php echo $selected_grade; ?> - VocabWorld</title>
    <link rel="stylesheet" href="../style.css?v=3">
    <link rel="stylesheet" href="../navigation/navigation.css?v=3">
    <link rel="stylesheet" href="learnvocabmenu.css?v=1">
...
<body>
        ...
        <div id="main-menu" class="screen active">
            <div class="menu-container">
                ...
                <div class="page-header">
                    <h1 class="page-title">Vocabulary - Grade <?php echo $selected_grade; ?></h1>
                    <p class="page-subtitle">Study and practice vocabulary words for your grade level</p>
                </div>
                
                <div class="search-container">
                    <input type="text" id="vocab-search" placeholder="Search vocabulary words..." class="search-input">
    ...
    <script>
        ...
        window.userData = {
            ...
            selectedGrade: <?php echo $selected_grade; ?>
        };
